...
<param name=\"argos_world_file_name\" value=\"/argos_worlds/rand_environments/no_walls.argos\"/> </node>"  >> $LAUNCH_FILE
...
#echo -e "<param name=\"input_file\" value=\"/gen_15_winner\" />"  >> $LAUNCH_FILE
